...
import com.jk.ucenter.utils.ConstantWxUtils;
import com.jk.ucenter.utils.HttpClientUtils;
    ...
    public String callback(String code, String state) {
        try {
            ...
            if(member == null) {//memeber是空，表没有相同微信数据，进行添加
                ...
                System.out.println("微信扫码人信息："+userInfo);
            ...
            throw new MyDefineException(20001,"登录失败");
        }
    }
